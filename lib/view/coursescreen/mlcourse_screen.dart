...
class MlCourseScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // ดึงข้อมูลจาก CourseProvider
    final courseProvider = Provider.of<CourseProvider>(context);
    final mlcourse = courseProvider.courses
        .where((course) => course.courseType == CourseType.Ml)
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: ListView.separated(
                                    ...
                                    itemCount: mlcourse.length,
                                    itemBuilder: (context, index) {
                                      return CourseContainer(
                                        course: mlcourse[index],
