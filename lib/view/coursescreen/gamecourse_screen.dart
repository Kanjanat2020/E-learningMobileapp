...
class GameCourseScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // ดึงข้อมูลจาก CourseProvider
    final courseProvider = Provider.of<CourseProvider>(context);
    final gamecourse = courseProvider.courses
        .where((course) => course.courseType == CourseType.Game)
        .toList();
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: ListView.separated(
                                    ...
                                    itemCount: gamecourse.length,
                                    itemBuilder: (context, index) {
                                      return CourseContainer(
                                        course: gamecourse[index],
                                        goTo: gamecourse[index].detailcourse,
                                      );
                                    },
                                  ),
                                )
