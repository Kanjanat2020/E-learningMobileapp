...
class MobileCourseScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // ดึงข้อมูลจาก CourseProvider
    final courseProvider = Provider.of<CourseProvider>(context);
    final mobilecourse = courseProvider.courses
        .where((course) => course.courseType == CourseType.Mobile)
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Stack(
            children: [
              Positioned(
                top: 150, // ระยะจากด้านบน
                right: -10, // ระยะจากด้านขวา
                child: Transform.scale(
                  scale: 1, // ขยายขนาดรูปภาพ
                  child: Image.asset(
                    "assets/images/mobile_dev.png",
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: ListView.separated(
                                    ...
                                    itemCount: mobilecourse.length,
                                    itemBuilder: (context, index) {
                                      return CourseContainer(
                                        course: mobilecourse[index],
