...
class WebCourseScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // ดึงข้อมูลจาก CourseProvider
    final courseProvider = Provider.of<CourseProvider>(context);
    final webcourse = courseProvider.courses
        .where((course) => course.courseType == CourseType.Web)
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: ListView.separated(
                                    ...
                                    itemCount: webcourse.length,
                                    itemBuilder: (context, index) {
                                      return CourseContainer(
                                        course: webcourse[index],
                                        goTo: webcourse[index].detailcourse,
                                      );
                                    },
                                  ),
                                )
