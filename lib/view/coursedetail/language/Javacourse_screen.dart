...
class JavaCourseDetailsScreen extends StatefulWidget {
  const JavaCourseDetailsScreen({super.key});

  @override
  State<JavaCourseDetailsScreen> createState() => _JavaCourseDetailsScreenState();
}

class _JavaCourseDetailsScreenState extends State<JavaCourseDetailsScreen> {
  int _selectedTag = 0;
