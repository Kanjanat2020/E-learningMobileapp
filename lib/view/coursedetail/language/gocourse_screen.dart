...
class GoCourseDetailsScreen extends StatefulWidget {
  const GoCourseDetailsScreen({super.key});

  @override
  State<GoCourseDetailsScreen> createState() => _GoCourseDetailsScreenState();
}

class _GoCourseDetailsScreenState extends State<GoCourseDetailsScreen> {
  int _selectedTag = 0;
