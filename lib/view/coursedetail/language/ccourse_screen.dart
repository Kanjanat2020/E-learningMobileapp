...
class CCourseDetailsScreen extends StatefulWidget {
  const CCourseDetailsScreen({super.key});

  @override
  State<CCourseDetailsScreen> createState() => _CCourseDetailsScreenState();
}

class _CCourseDetailsScreenState extends State<CCourseDetailsScreen> {
  int _selectedTag = 0;
