...
class RubyCourseDetailsScreen extends StatefulWidget {
  const RubyCourseDetailsScreen({super.key});

  @override
  State<RubyCourseDetailsScreen> createState() => _RubyCourseDetailsScreenState();
}

class _RubyCourseDetailsScreenState extends State<RubyCourseDetailsScreen> {
  int _selectedTag = 0;
