...
class PythonCourseDetailsScreen extends StatefulWidget {
  const PythonCourseDetailsScreen({super.key});

  @override
  State<PythonCourseDetailsScreen> createState() => _PythonCourseDetailsScreenState();
}

class _PythonCourseDetailsScreenState extends State<PythonCourseDetailsScreen> {
  int _selectedTag = 0;
