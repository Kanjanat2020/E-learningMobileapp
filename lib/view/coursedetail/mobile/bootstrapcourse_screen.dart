...
class BootstrapCourseDetailsScreen extends StatefulWidget {
  const BootstrapCourseDetailsScreen({super.key});

  @override
  State<BootstrapCourseDetailsScreen> createState() => _BootstrapCourseDetailsScreenState();
}

class _BootstrapCourseDetailsScreenState extends State<BootstrapCourseDetailsScreen> {
  int _selectedTag = 0;
