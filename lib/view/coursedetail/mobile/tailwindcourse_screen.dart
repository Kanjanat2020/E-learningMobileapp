...
class TailwindCourseDetailsScreen extends StatefulWidget {
  const TailwindCourseDetailsScreen({super.key});

  @override
  State<TailwindCourseDetailsScreen> createState() => _TailwindCourseDetailsScreenState();
}

class _TailwindCourseDetailsScreenState extends State<TailwindCourseDetailsScreen> {
  int _selectedTag = 0;
