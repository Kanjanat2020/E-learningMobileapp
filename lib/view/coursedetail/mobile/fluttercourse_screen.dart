...
class FlutterCourseDetailsScreen extends StatefulWidget {
  const FlutterCourseDetailsScreen({super.key});

  @override
  State<FlutterCourseDetailsScreen> createState() => _FlutterCourseDetailsScreenState();
}

class _FlutterCourseDetailsScreenState extends State<FlutterCourseDetailsScreen> {
  int _selectedTag = 0;
