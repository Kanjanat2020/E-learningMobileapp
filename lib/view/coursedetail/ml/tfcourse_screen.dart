...
class TfCourseDetailsScreen extends StatefulWidget {
  const TfCourseDetailsScreen({super.key});

  @override
  State<TfCourseDetailsScreen> createState() => _TfCourseDetailsScreenState();
}

class _TfCourseDetailsScreenState extends State<TfCourseDetailsScreen> {
  int _selectedTag = 0;
