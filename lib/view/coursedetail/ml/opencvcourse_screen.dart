...
class OpencvCourseDetailsScreen extends StatefulWidget {
  const OpencvCourseDetailsScreen({super.key});

  @override
  State<OpencvCourseDetailsScreen> createState() => _OpencvCourseDetailsScreenState();
}

class _OpencvCourseDetailsScreenState extends State<OpencvCourseDetailsScreen> {
  int _selectedTag = 0;
