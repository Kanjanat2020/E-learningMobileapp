...
class PtCourseDetailsScreen extends StatefulWidget {
  const PtCourseDetailsScreen({super.key});

  @override
  State<PtCourseDetailsScreen> createState() => _PtCourseDetailsScreenState();
}

class _PtCourseDetailsScreenState extends State<PtCourseDetailsScreen> {
  int _selectedTag = 0;
