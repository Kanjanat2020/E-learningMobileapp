...
class WebCourseDetailsScreen extends StatefulWidget {
  const WebCourseDetailsScreen({super.key});

  @override
  State<WebCourseDetailsScreen> createState() => _WebCourseDetailsScreenState();
}

class _WebCourseDetailsScreenState extends State<WebCourseDetailsScreen> {
  int _selectedTag = 0;
