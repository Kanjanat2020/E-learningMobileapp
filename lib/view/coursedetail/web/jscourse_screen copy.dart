...
class JsCourseDetailsScreen extends StatefulWidget {
  const JsCourseDetailsScreen({super.key});

  @override
  State<JsCourseDetailsScreen> createState() => _JsCourseDetailsScreenState();
}

class _JsCourseDetailsScreenState extends State<JsCourseDetailsScreen> {
  int _selectedTag = 0;
