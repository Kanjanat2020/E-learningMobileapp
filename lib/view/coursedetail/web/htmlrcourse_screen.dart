...
class HTMLCourseDetailsScreen extends StatefulWidget {
  const HTMLCourseDetailsScreen({super.key});

  @override
  State<HTMLCourseDetailsScreen> createState() => _HTMLCourseDetailsScreenState();
}

class _HTMLCourseDetailsScreenState extends State<HTMLCourseDetailsScreen> {
  int _selectedTag = 0;
