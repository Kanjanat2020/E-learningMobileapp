...
class CssCourseDetailsScreen extends StatefulWidget {
  const CssCourseDetailsScreen({super.key});

  @override
  State<CssCourseDetailsScreen> createState() => _CssCourseDetailsScreenState();
}

class _CssCourseDetailsScreenState extends State<CssCourseDetailsScreen> {
  int _selectedTag = 0;
