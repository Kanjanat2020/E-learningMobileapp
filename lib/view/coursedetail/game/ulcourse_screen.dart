...
class UlCourseDetailsScreen extends StatefulWidget {
  const UlCourseDetailsScreen({super.key});

  @override
  State<UlCourseDetailsScreen> createState() => _UlCourseDetailsScreenState();
}

class _UlCourseDetailsScreenState extends State<UlCourseDetailsScreen> {
  int _selectedTag = 0;
